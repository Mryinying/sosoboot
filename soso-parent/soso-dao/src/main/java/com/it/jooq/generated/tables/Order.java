...
public class Order extends TableImpl<OrderRecord> {
    ...
    private static final long serialVersionUID = -789567419;
     ...
     */
    public final TableField<OrderRecord, Integer> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT, this, "订单状态", new Byte2IntegerConverter());

    /**
     * The column <code>study.order.order_time</code>. 订单时间
     */
    public final TableField<OrderRecord, Date> ORDER_TIME = createField("order_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "订单时间", new Timestamp2DateConverter());
