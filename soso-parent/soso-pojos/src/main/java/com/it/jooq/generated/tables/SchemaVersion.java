...
public class SchemaVersion extends TableImpl<SchemaVersionRecord> {
    ...
    private static final long serialVersionUID = -636178228;
     ...
     */
    public final TableField<SchemaVersionRecord, Date> INSTALLED_ON = createField("installed_on", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "", new Timestamp2DateConverter());
     ...
     */
    public final TableField<SchemaVersionRecord, Integer> SUCCESS = createField("success", org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "", new Byte2IntegerConverter());
